...
import com.example.reminderapp.util.GeofenceReceiver
...
const val GEOFENCE_DWELL_DELAY =  30 * 1000 // 10 secs // 2 minutes
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    get() = Navigation.findNavController(this, R.id.map)*/
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // this code was added to read the message sent from the main screen to
        //display on the map location. it didn't work as the bundle object was null
        /*val bundle = getIntent().getExtras()
        if(bundle != null)
        {
            val v : String? = bundle.getString("reminder")
            Log.i("okay",v.toString())
        }*/
    ...
    private fun createGeoFence(location: LatLng, geofencingClient: GeofencingClient) {
        ...
        val intent = Intent(this, GeofenceReceiver::class.java)
            //.putExtra("key", key)
            .putExtra("lattitude", "${location.latitude}")
            .putExtra("longitude", "${location.longitude}")
            .putExtra("message", "Geofence alert - You have a reminder at this location")
